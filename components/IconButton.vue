...
<template>
  <ActionTrigger
    ref="triggerRef"
    class="group relative flex flex-col items-stretch rounded-sm px-1 py-1 text-center text-xs/none focus:outline-none focus-visible:outline-2 focus-visible:outline-primary not-disabled:hover:bg-primary/10 dark:focus-visible:outline-primary-400 dark:not-disabled:hover:bg-primary/10 sm:px-2 sm:py-2 sm:text-icon/[1.15] md:py-3"
    :class="
      disabled
